...
export const SHOWCASED_PROJECT_DESCRIPTION =
  "Crop Recommendation This dataset contains information on the levels of nitrogen, phosphorus, and potassium in soil, as well as temperature, humidity, pH, and rainfall, and their impact on the growth of crops. The data can be used to make data-driven recommendations for achieving optimal nutrient and environmental conditions to improve crop yield.";
...
export const PROJECT_DETAILS = [
  ...
  },
  {
    ...
    href: "/work/twitter-clone-website",
  },
  {
    ...
    href: "/work/netflix-clone-website",
  },
  {
    ...
    href: "/work/google-clone-website",
  },
  {
