export default function VolunteerClock() {
  return (
    <div className="flex flex-col gap-2">
      <section>
        <h2 className="pb-1 text-3xl font-bold">Introduction</h2>
        <p>
      ...
      <section>
        <h2 className="pb-1 text-3xl font-bold">The Problem</h2>
        <p>
      ...
      <section>
        ...
        <ol className="list-outside list-decimal pl-5">
          <li>
            ...
            check-ins/check-outs, and token minting. The use of ERC1155 tokens
            for representing volunteer activities ensures that contributions are
          ...
          <li>
            ...
            authority and distributing control among participants, which
      ...
      <section>
        ...
        <ol className="list-outside list-decimal py-2 pl-5">
          <li>
            Contract Deployment and Management: All operations related to
            project management and volunteer interactions are handled by
            specific smart contracts, which are deployed on the Ethereum
            network.
          </li>
          <li>
          ...
          <li>
            Security and Data Privacy: Advanced security protocols are
            implemented to protect the system from common vulnerabilities, and
            privacy is maintained to protect volunteer identities as needed.
          </li>
        </ol>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          volunteer management systems, it also recognizes potential areas for
          improvement, such as enhancing the handling of multi-day events,
          improving time tracking accuracy, and expanding the flexibility of the
          token minting process.
        </p>
      </section>

      <section>
        <h2 className="pb-1 text-3xl font-bold">Conclusion</h2>
        <p>
          VolunteerClock is not just a tool for managing volunteer activities
          but a step forward in how technology can be used to foster a more
          accountable, transparent, and efficient system for community
          involvement. It showcases the practical use of blockchain technology
          in real-world applications, reflecting a deep understanding of both
          the technology and the needs of the community service ecosystem.
        </p>
      </section>
    </div>
  );
