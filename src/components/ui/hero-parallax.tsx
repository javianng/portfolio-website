...
export const HeroParallax = ({
  ...
  return (
    <div
      ref={ref}
      className="relative flex h-[180rem] flex-col self-auto  overflow-hidden py-40 antialiased [perspective:1000px] [transform-style:preserve-3d]"
    >
      <Header />
      <motion.div
        style={{
...
export const Header = () => {
  return (
    <div className="relative left-0 top-0 mx-auto w-full max-w-7xl px-4  py-20 md:py-40">
      <TitleContainer id="Work">My Work</TitleContainer>
...
export const ProductCard = ({
  ...
  return (
    ...
    >
      <Link
        href={product.link}
        className="group-hover/product:shadow-2md block"
      >
        <Image
