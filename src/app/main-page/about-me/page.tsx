  ...
  return (
    <ScrollArea className="w-full rounded-lg shadow-md">
      <main className="flex h-full min-h-[90vh] flex-col items-end justify-start bg-white p-4 text-justify">
        <article className="w-full pb-10 sm:w-3/5">
          <h1 className="h1 text-end" id="about me">
            about me
          </h1>
          <p className="p">
          ...
          <p className="p">
            ...
            make meaningful contributions to critical health issues. It's an
            exhilarating experience that has deepened my understanding of
        ...
        <section className="w-full sm:w-3/5">
          <h2 className="h2 text-end">skillsets</h2>
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="frontend-development">
              ...
              <AccordionContent>
                <p>
                  ...
                  Vue, I strive to create seamless user experiences that delight
                  and engage users.
                </p>
              </AccordionContent>
            ...
            <AccordionItem value="backend-development">
              ...
              <AccordionContent>
                As a backend developer, I specialize in building the backbone of
                web applications. Proficient in technologies like Node.js, SQL,
                and NoSQL databases, I design and implement robust server-side
                architectures to handle data storage, retrieval, and processing,
                ensuring seamless functionality for frontend interfaces.
              </AccordionContent>
              <AccordionContent className="space-x-1">
                <Link
            ...
            <AccordionItem value="data-analytics">
              ...
              <AccordionContent>
                ...
                analysis, and machine learning tasks. My passion lies in turning
                data into actionable insights that drive informed
                decision-making.
              </AccordionContent>
              <AccordionContent className="space-x-1">
                <Link
            ...
            <AccordionItem value="software-development">
              ...
              <AccordionContent>
                In software development, my focus is on architecting robust and
                scalable solutions. With expertise in languages like JavaScript
                and TypeScript, along with frameworks like Node.js, I enjoy
                tackling complex challenges to deliver efficient and
