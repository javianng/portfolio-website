...
export default function Page() {
  return (
    <ScrollArea className="w-full rounded-md shadow-md">
      <main className="text flex h-full min-h-[90vh] flex-col items-start justify-start bg-white p-4 dark:bg-neutral-900">
        ...
        <section className="w-full border-l-2 pl-5 sm:w-5/6 lg:w-3/5">
          <ContactForm />
        </section>
      </main>
    </ScrollArea>
